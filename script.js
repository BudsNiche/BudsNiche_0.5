...
enterDiscussionBtn.addEventListener("click", () => {
  const isHidden = discussionPanel.classList.contains("hidden");
  discussionPanel.classList.toggle("hidden");
  enterDiscussionBtn.textContent = isHidden
